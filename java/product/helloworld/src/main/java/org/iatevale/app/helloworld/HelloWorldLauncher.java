...
public class HelloWorldLauncher {
    ...
    static final public java.util.logging.Logger LOGGER = java.util.logging.Logger.getLogger(HelloWorldLauncher.class.getName().replace("org.iatevale.", ""));
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (!finishServer) {
                synchronized (HelloWorldLauncher.class) {
                    try {
                        HelloWorldLauncher.class.wait(2000);
    ...
    static final class Finisher implements Runnable {
        ...
        public void run() {
            ...
            HelloWorldLauncher.LOGGER.info("Se ha solicitado la parada ...");

            // Se despierta el thread principal para que evalue si tiene que parar
            synchronized (HelloWorldLauncher.class) {
                HelloWorldLauncher.finishServer = true;
                HelloWorldLauncher.class.notifyAll();
            }
